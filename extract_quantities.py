...
def calculate_volume_alternative(element):
    ...
    try:
        ...
        print(f"Erro ao calcular geometria para {log_element_details(element)}: {e}")
    ...
    try:
        ...
        for element_type in elements_to_check:
            ...
            for element in elements:
                print(f"Processando elemento: {log_element_details(element)}")
                volume = 0
                ...
                try:
                    ...
                    print(f"Elemento {log_element_details(element)} não possui 'HasQuantities'.")
